...
export const getDataKatalog = () => {
    try {
        return async dispatch => {
            const result = await fetch('http://192.168.42.219:8000/sirius_api/katalog/', {
                'method': 'GET',
                headers: {
...
export const getUserBanget = (id) => {
    try {
        return async dispatch => {
            const result = await fetch('http://192.168.42.219:8000/sirius_api/lihat_users/' + id + '/', {
                'method': 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
...
export const getPinjamAlat = () => {
    try {
        return async dispatch => {
            const result = await fetch('http://192.168.42.219:8000/sirius_api/pinjam_alat/', {
                'method': 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
...
export const getDataOrderLog = () => {
    try {
        return async dispatch => {
            const result = await fetch('http://192.168.42.219:8000/sirius_api/order_log/', {
                'method': 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
